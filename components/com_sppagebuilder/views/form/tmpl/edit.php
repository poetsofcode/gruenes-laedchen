...
<div id="sp-page-builder" class="sp-pagebuilder <?php echo $menuClassPrefix; ?> page-<?php echo $this->item->id; ?>" data-pageid="<?php echo $this->item->id; ?>">
	...
	<iframe name="sp-pagebuilder-view" id="sp-pagebuilder-view" data-url="<?php echo JURI::root(); ?>index.php?option=com_sppagebuilder&view=form&id=<?php echo $this->item->id; ?>&layout=edit-iframe&Itemid=<?php echo $Itemid; ?>"></iframe>
