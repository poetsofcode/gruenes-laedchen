...
class JFormFieldIgToken extends JFormField
{
    ...
    protected function getInput()
    {
		...
		$html[] = 		'<div class="controls">';
		$html[] = 			'<button type="button" onclick="Joomla.submitbutton(\'config.save.component.apply\');" id="ig_next" class="btn btn-primary">' . Text::_('COM_SPPAGEBUILDER_BTN_NEXT') . '</button>';
		$html[] = 		'</div>';
		$html[] = 	'</div>';
