	...
	'attr' 	=> array(
		'general' => array(
			...
			'container_separator'=>array(
				'type'=>'separator',
				'title'=>JText::_('COM_SPPAGEBUILDER_ROW_CONTAINER_STYLE'),
			),
			'container_width'=>array(
				'type'=>'slider',
				'title'=>JText::_('COM_SPPAGEBUILDER_GLOBAL_CONTAINER_WIDTH'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_GLOBAL_CONTAINER_WIDTH_DESC'),
				'max'=> 1600,
				'min'=> 1200,
				'depends'=>array(
					array('fullscreen', '=', 0),
			...
			'columns_gap'=>array(
				'type'=>'slider',
				'title'=>JText::_('COM_SPPAGEBUILDER_GLOBAL_COLUMNS_GAP'),
				'max'=> 100,
				'min'=> 0,
				'unit' => true,
				'responsive' => true,
		...
		'style' => array(
			...
			'height_separator'=>array(
				'type'=>'separator',
				'title'=>JText::_('COM_SPPAGEBUILDER_ROW_HEIGHT_SETTIINGS'),
			),
			...
			'section_min_height'=>array(
				'type'=>'slider',
				'title'=>JText::_('COM_SPPAGEBUILDER_ROW_MIN_HEIGHT_OPTION'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ROW_MIN_HEIGHT_OPTION_DESC'),
				'max'=>3000,
				'responsive' => true,
			),
			'section_max_height'=>array(
				'type'=>'slider',
				'title'=>JText::_('COM_SPPAGEBUILDER_ROW_MAX_HEIGHT_OPTION'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ROW_MAX_HEIGHT_OPTION_DESC'),
				'max'=>3000,
				'responsive' => true,
			),
			...
			'width_separator'=>array(
				'type'=>'separator',
				'title'=>JText::_('COM_SPPAGEBUILDER_ROW_WIDTH_SETTINGS'),
			),
			'row_width'=>array(
				'type'=>'slider',
				'title'=>JText::_('COM_SPPAGEBUILDER_ROW_WIDTH'),
				'unit'=> true,
				'max'=> 3000,
				'min'=> 0,
				'responsive' => true,
			...
			'row_max_width'=>array(
				'type'=>'slider',
				'title'=>JText::_('COM_SPPAGEBUILDER_GLOBAL_MAX_WIDTH'),
				'unit'=> true,
				'max'=> 3000,
				'min'=> 0,
				'responsive' => true,
			...
			'row_min_width'=>array(
				'type'=>'slider',
				'title'=>JText::_('COM_SPPAGEBUILDER_GLOBAL_MIN_WIDTH'),
				'unit'=> true,
				'max'=> 3000,
				'min'=> 0,
				'responsive' => true,
			...
			'other_separator'=>array(
				'type'=>'separator',
				'title'=>JText::_('COM_SPPAGEBUILDER_ROW_OTHER_SETTINGS'),
			),
			'padding'=>array(
				'type'=>'padding',
			...
			'row_border_radius'=>array(
				...
				'desc'=>JText::_('COM_SPPAGEBUILDER_GLOBAL_BORDER_RADIUS_ROW_DESC'),
				'std'=>0,
				'max'=>500,
				'responsive'=> true
			),
